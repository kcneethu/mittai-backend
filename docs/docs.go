    ...
    "paths": {
        ...
        "/users/check-mobile": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Mobile number check response indicating whether the mobile number exists along with the user ID if it does.",
                        "schema": {
                            "$ref": "#/definitions/models.MobileCheckResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request - JSON body is required and must contain a 'contact_number'.",
                        "schema": {
                            "$ref": "#/definitions/services.ErrorResponse"
                        }
                    },
                    "500": {
                        "description": "Internal server error - Failed to check mobile number due to a server error.",
                        "schema": {
                            "$ref": "#/definitions/services.ErrorResponse"
                        }
                    }
